...
public:
	...
	virtual vector<Pair> draw_sample(int ji_ratio) const;
	virtual vector<Pair> draw_sample_no_shuffle(int ji_ratio) const;
	virtual vector<Pair> draw_sample(size_t u, int ji_ratio) const;
	virtual vector<Pair> draw_sample_no_shuffle(size_t u, int ji_ratio) const;
};
